...
public class CriarSolicitacaoProdutoRequest {
    ...
    public CriarSolicitacaoProdutoRequest() {}

    public CriarSolicitacaoProdutoRequest(String nomeProduto, Integer quantidade, String solicitante,
